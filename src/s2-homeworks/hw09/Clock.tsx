...
function Clock() {
  ...
  const stringTime = `${date.getHours()}:${date
    .getMinutes()
    .toString()
    .padStart(2, "0")}:${date
    .getSeconds()
    .toString()
    .padStart(2, "0")}` || <br />; // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
  ...
  const stringDay = `${date.toLocaleString("default", {
    weekday: "long",
  })}` || <br />; // пишут студенты
  const stringMonth = `${date.toLocaleString("default", {
    month: "long",
  })}` || <br />; // пишут студенты
